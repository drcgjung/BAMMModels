...
# REMARKS:
# ========
# This script validates a set of artifacts for a given BAMM model in a ttl-file.
# Preconditiions:
...
# ./validate.sh com.catenax/0.0.1/ProductUsage.ttl
# Apply script to a set of files
# For file in ./com.catenax/0.0.1/*; do ./validate.sh $file
